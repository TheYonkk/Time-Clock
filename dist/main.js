        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
            ...
            success: function(data) {
                ...
                if(json.ok) {
                    ...
                    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".clock-override").fadeOut(500);
                    ...
                    if (json.enableOverride){
                        jquery__WEBPACK_IMPORTED_MODULE_0___default()(".clock-override").fadeIn(500);
